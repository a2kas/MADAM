...
public static class LongSpecificationExtensions
{
    public static void ApplyLongFilter<T>(this ISpecificationBuilder<T> builder, string filterOperator, object filterObject, Expression<Func<T, long>> propertySelector)
        where T : class
    {
        ...
        long.TryParse(filterObject.ToString(), out var filterValue);
    ...
    private static Expression<Func<T, bool>> CreateEqualsExpression<T>(Expression<Func<T, long>> propertySelector, long value)
    {
        var parameterExp = propertySelector.Parameters[0];
        var propertyExp = propertySelector.Body;
        var valueExp = Expression.Constant(value, typeof(long));
    ...
    private static Expression<Func<T, bool>> CreateNotEqualsExpression<T>(Expression<Func<T, long>> propertySelector, long value)
    {
        var parameterExp = propertySelector.Parameters[0];
        var propertyExp = propertySelector.Body;
        var valueExp = Expression.Constant(value, typeof(long));
    ...
    private static Expression<Func<T, bool>> CreateGreaterThanExpression<T>(Expression<Func<T, long>> propertySelector, long value)
    {
        var parameterExp = propertySelector.Parameters[0];
        var propertyExp = propertySelector.Body;
        var valueExp = Expression.Constant(value, typeof(long));
    ...
    private static Expression<Func<T, bool>> CreateLessThanExpression<T>(Expression<Func<T, long>> propertySelector, long value)
    {
        var parameterExp = propertySelector.Parameters[0];
        var propertyExp = propertySelector.Body;
        var valueExp = Expression.Constant(value, typeof(long));
    ...
    private static Expression<Func<T, bool>> CreateLessThanOrEqualExpression<T>(Expression<Func<T, long>> propertySelector, long value)
    {
        var parameterExp = propertySelector.Parameters[0];
        var propertyExp = propertySelector.Body;
        var valueExp = Expression.Constant(value, typeof(long));
    ...
    private static Expression<Func<T, bool>> CreateGreaterThanOrEqualExpression<T>(Expression<Func<T, long>> propertySelector, long value)
    {
        var parameterExp = propertySelector.Parameters[0];
        var propertyExp = propertySelector.Body;
        var valueExp = Expression.Constant(value, typeof(long));
    ...
    private static Expression<Func<T, bool>> CreateIsEmptyExpression<T>(Expression<Func<T, long>> propertySelector)
    {
        var parameterExp = propertySelector.Parameters[0];
        var propertyExp = propertySelector.Body;

        var isNullExp = Expression.Equal(propertyExp, Expression.Constant((long)0, typeof(long)));

        return Expression.Lambda<Func<T, bool>>(isNullExp, parameterExp);
    }

    private static Expression<Func<T, bool>> CreateIsNotEmptyExpression<T>(Expression<Func<T, long>> propertySelector)
    {
        var parameterExp = propertySelector.Parameters[0];
        var propertyExp = propertySelector.Body;

        var isNullExp = Expression.NotEqual(propertyExp, Expression.Constant((long)0, typeof(long)));
