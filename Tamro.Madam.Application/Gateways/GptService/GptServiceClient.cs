...
namespace Tamro.Madam.Application.Gateways.GptService
{
    ...
    public partial interface IContractExtractionsClient
    {
        ...
        System.Threading.Tasks.Task<object> ExtractInfoAsync(System.IO.Stream body, string fileName, Token token = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.15.10.0 (NJsonSchema v10.6.10.0 (Newtonsoft.Json v9.0.0.0))")]
    public partial class ContractExtractionsClient : IContractExtractionsClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public ContractExtractionsClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <returns>Successful Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> ExtractInfoAsync(System.IO.Stream body, string fileName, Token token = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (body == null)
                throw new System.ArgumentNullException("body");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("v1/ai/documents/contractExtractions?");
            if (token != null)
            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var fileContent = new System.Net.Http.StreamContent(body);

                    // Set appropriate headers for the file (similar to Swagger UI request)
                    fileContent.Headers.ContentDisposition = new System.Net.Http.Headers.ContentDispositionHeaderValue("form-data")
                    {
                        Name = "\"file\"",
                        FileName = fileName,
                    };
                    fileContent.Headers.ContentType = fileName.EndsWith("pdf") ? new System.Net.Http.Headers.MediaTypeHeaderValue("application/pdf") : new System.Net.Http.Headers.MediaTypeHeaderValue("application/msword");
    ...
    public partial class Body_ContractExtractions_ExtractInfo
    {
