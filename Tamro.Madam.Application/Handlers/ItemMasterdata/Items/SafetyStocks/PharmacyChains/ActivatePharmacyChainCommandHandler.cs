...
public class ActivatePharmacyChainCommandHandler : IRequestHandler<ActivatePharmacyChainCommand, Result<int>>
{
    private readonly IMadamUnitOfWork _uow;

    public ActivatePharmacyChainCommandHandler(IMadamUnitOfWork uow)
    {
        _uow = uow;
    }

    public async Task<Result<int>> Handle(ActivatePharmacyChainCommand command, CancellationToken cancellationToken)
    {
