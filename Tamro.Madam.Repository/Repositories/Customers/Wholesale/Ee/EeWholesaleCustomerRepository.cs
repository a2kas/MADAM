...
namespace Tamro.Madam.Repository.Repositories.Customers.Wholesale.Ee;

public class EeWholesaleCustomerRepository : IWholesaleCustomerRepository
{
    private readonly IWhRawEeDatabaseContext _context;
    private readonly IMapper _mapper;

    public EeWholesaleCustomerRepository(IWhRawEeDatabaseContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }
    ...
    private IQueryable<EeWholesaleCustomer> BuildQuery(IEnumerable<int> addressNumbers, WholesaleCustomerType customerType)
    {
        var query = _context
            .Customers
            .AsNoTracking();
    ...
    private IQueryable<EeWholesaleCustomer> BuildQuery(string searchTerm, WholesaleCustomerType customerType)
    {
        var query = _context
            .Customers
            .AsNoTracking();
    ...
    private IQueryable<EeWholesaleCustomer> BuildQuery(WholesaleCustomerSearchModel search)
    {
        var query = _context
            .Customers
            .AsNoTracking();
