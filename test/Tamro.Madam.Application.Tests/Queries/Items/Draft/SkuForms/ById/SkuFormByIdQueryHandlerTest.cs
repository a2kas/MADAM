...
namespace Tamro.Madam.Application.Tests.Queries.Items.Draft.SkuForms.ById
{
    [TestFixture]
    public class SkuFormByIdQueryHandlerTests
    {
        ...
        private SkuFormByIdQueryHandler _handler;
        ...
        public void SetUp()
        {
            ...
            _handler = new SkuFormByIdQueryHandler(
        ...
        {
            // Arrange
            var query = new SkuFormByIdQuery
            {
                Id = 1
            };
