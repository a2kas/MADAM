...
[TestFixture]
public class LvCanceledOrderLinesEmailGeneratorTests
{
    private Fixture _fixture;
    private LvCanceledOrderLinesEmailGenerator _lvCanceledOrderLinesEmailGenerator;
    ...
    public void SetUp()
    {
        ...
        _lvCanceledOrderLinesEmailGenerator = new LvCanceledOrderLinesEmailGenerator();
    }
    ...
    public void GenerateCanceledLinesEmail_GeneratesCorrectEmail()
    {
        ...
        // Act
        var email = _lvCanceledOrderLinesEmailGenerator.GenerateCanceledLinesEmail(ordersByRecipient);

        // Assert
        email.ShouldNotBeNull();
        email.Subject.ShouldBe("Informācija par pasūtījuma izpildi");
        email.Receivers.Count.ShouldBe(1);
        email.Receivers[0].ShouldBe("someemail@tamro.com");
    ...
    public void GenerateMissingEmailsNotification_GeneratesCorrectNotification()
    {
        ...
        // Act
        var email = _lvCanceledOrderLinesEmailGenerator.GenerateMissingEmailsNotification(responsiblePerson, ordersWithMissingEmail);
