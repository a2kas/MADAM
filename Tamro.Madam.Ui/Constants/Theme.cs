...
namespace Tamro.Madam.Ui.Constants;

public static class Theme
{
    public static MudTheme GetTamroTheme()
    {
        return new MudTheme()
        {
            PaletteLight = new PaletteLight()
            {
                ...
                Tertiary = "#68738D",
                ActionDefault = "#969595",
                OverlayDark = "rgba(33,33,33,0.580392156862745)",
            },
            ...
            Typography = new Typography
            {
                Default = new DefaultTypography
                {
                    ...
                    FontFamily = new string[] { "Roboto", "Public Sans", "Roboto", "Arial", "sans-serif" }
                },
                H1 = new H1Typography
                {
                    FontSize = "4rem",
