...
namespace Tamro.Madam.Ui.Pages.ItemMasterdata.Requestors.Components;

public partial class RequestorDetailsDialog
{
    [EditorRequired]
    [Parameter]
    ...
    private async Task Submit()
    {
        try
        {
            ...
            var result = await _mediator.Send(new UpsertRequestorCommand(Model));
    ...
    private string GetTitle()
    {
        return State switch
        {
            DialogState.Create => $"Create new requestor",
            DialogState.View => $"Requestor",
            DialogState.Copy => $"Copy requestor",
            _ => "",
        };
    }
    ...
    private string GetSuccessMessage()
    {
        return State switch
        {
            DialogState.Create or DialogState.Copy => $"Requestor {Model.Name} created",
            DialogState.View => $"Requestor {Model.Name} updated",
            _ => "",
        };
    }
